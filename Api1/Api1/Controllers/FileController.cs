...
namespace Api1.Controllers
{
    ...
    public class FileController : Controller
    {
        ...
        //есть поле для загрузки, но выйл не загружается
        // public async Task<IActionResult> AddFile([FromForm]Box uploadedFile, CategoryDTO category)
        // public async Task<IActionResult> AddFile([FromForm] IFormFile uploadedFile, CategoryDTO category)
